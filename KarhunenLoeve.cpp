...
// KarhunenLoeve.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CKarhunenLoeveApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CKarhunenLoeveApp

CKarhunenLoeveApp::CKarhunenLoeveApp()
{
...
// Единственный объект CKarhunenLoeveApp

CKarhunenLoeveApp theApp;


// Инициализация CKarhunenLoeveApp

BOOL CKarhunenLoeveApp::InitInstance()
{
